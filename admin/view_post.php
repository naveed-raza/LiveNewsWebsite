...
<table  align='center' border='3' style='margin:50px;'>
	...
	<tr>
		...
		<td align='center' style='font-weight:bold;'> Post category</td>
	    <td align='center' style='font-weight:bold;'> Post date</td>
	    <td align='center' style='font-weight:bold;'> Post author</td>
        <td align='center' style='font-weight:bold;'> Post image</td>
...
?>
	...
	<tr>
        ...
        <td align='center'> <img src="images/<?php echo $image; ?>" width='50' height='50' align='center'></td>
